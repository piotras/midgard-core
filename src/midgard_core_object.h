...
#define MGD_CNC_WORKSPACE_ID(_cnc) MGD_CNC_WORKSPACE(_cnc) ? MIDGARD_WORKSPACE_STORAGE_GET_INTERFACE(MGD_CNC_WORKSPACE(_cnc))->priv->get_id(MIDGARD_WORKSPACE_STORAGE (MGD_CNC_WORKSPACE(_cnc))) : 0
